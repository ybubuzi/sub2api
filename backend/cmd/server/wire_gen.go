...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	nodeRelayBalanceExecutor := service.NewNodeRelayBalanceExecutor()
	relayBalanceService := service.ProvideRelayBalanceService(relayBalanceRepository, nodeRelayBalanceExecutor)
	relayBalanceHandler := admin.NewRelayBalanceHandler(relayBalanceService)
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, grokOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, paymentHandler, affiliateHandler, complianceHandler, relayBalanceHandler, upstreamBillingProbeService)
