  ...
  admin: {
    ...
    groups: {
      ...
      mirror: {
        ...
        editTitle: 'Edit Mirror Mapping',
        badge: 'Mirror',
        rowBadge: '{platform} source group #{id}',
        unsupported: 'Only OpenAI and Anthropic group mirrors are supported.',
        targetPlatform: 'Client Platform',
        sourceGroup: 'Source group #{id}',
        enabled: 'Enabled',
        disabled: 'Disabled',
        mappingTitle: 'Model Mapping',
        mappingHint: 'Left is the mirror client request model. Right is the source group public model.',
        addMapping: 'Add Mapping',
        noMappings: 'No model mappings',
        clientModel: 'Client model',
        sourceModel: 'Source group public model',
        saved: 'Mirror group saved',
        failed: 'Failed to save mirror group',
        loading: 'Loading mirror state...',
        loadFailed: 'Failed to load mirror state',
        candidatesLoading: 'Loading model suggestions...',
        candidatesLoadFailed: 'Failed to load model suggestions',
        mappingIncomplete: 'Both client model and source platform model are required for each mapping.',
        mappingDuplicate: 'Duplicate client model mappings are not allowed.'
      },
      relationship: {
        title: 'Group Relationship Graph',
        button: 'Graph',
        maxKeys: 'Keys per group',
        summary: '{groups} groups · {keys} keys · {accounts} accounts',
        sourceGroup: 'Source Group',
        targetGroup: 'Target Group',
        selectGroup: 'Select group',
        previewTransfer: 'Preview Transfer',
        executeTransfer: 'Transfer',
        previewResult: 'Transfer Preview',
        transferResult: 'Transfer Result',
        matchedCount: '{count} keys matched',
        updatedCount: '{count} keys updated',
        transferSaved: 'Group bindings transferred',
        transferFailed: 'Failed to transfer group bindings',
        loadFailed: 'Failed to load relationship graph'
      },
      platforms: {
        all: 'All Platforms',
        anthropic: 'Anthropic',
    ...
    accounts: {
      ...
      dataImportWarning: 'Import will create or update accounts and proxies; groups must be bound manually.',
      dataImportFile: 'Data file',
      dataImportDuplicateAction: 'Duplicate accounts',
      dataImportDuplicateOverwrite: 'Overwrite',
      dataImportDuplicateCopy: 'Create copy',
      dataImportDuplicateIgnore: 'Ignore',
      dataImportBatchProxy: 'Batch proxy',
      dataImportBatchProxyFile: 'From file',
      dataImportBatchProxyNone: 'No proxy',
      dataImportPlatformGroups: 'Platform groups',
      dataImportPlatformGroupNone: 'Not set',
      dataImportOptionsLoadFailed: 'Failed to load import options',
      ...
      dataImportResultSummary: 'Proxies created {proxy_created}, reused {proxy_reused}, failed {proxy_failed}; Accounts created {account_created}, updated {account_updated}, ignored {account_ignored}, failed {account_failed}',
      dataImportErrors: 'Error Details',
      dataImportSuccess: 'Import completed: accounts created {account_created}, updated {account_updated}, ignored {account_ignored}, failed {account_failed}',
