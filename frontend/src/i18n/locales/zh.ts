  ...
  admin: {
    ...
    groups: {
      ...
      mirror: {
        ...
        editTitle: '编辑镜像映射',
        badge: '镜像',
        rowBadge: '{platform} 源分组 #{id}',
        unsupported: '当前只支持 OpenAI 与 Anthropic 分组互相创建镜像。',
        targetPlatform: '客户端平台',
        sourceGroup: '源分组 #{id}',
        enabled: '已启用',
        disabled: '未启用',
        mappingTitle: '模型映射',
        mappingHint: '左侧为镜像客户端请求模型，右侧为源分组对外模型。',
        addMapping: '添加映射',
        noMappings: '暂无模型映射',
        clientModel: '客户端模型',
        sourceModel: '源分组对外模型',
        ...
        loading: '正在读取镜像状态...',
        loadFailed: '镜像状态读取失败',
        candidatesLoading: '正在加载模型候选...',
        candidatesLoadFailed: '模型候选加载失败',
        mappingIncomplete: '模型映射必须同时填写客户端模型和源平台模型。',
        mappingDuplicate: '模型映射存在重复的客户端模型。'
      },
      relationship: {
        title: '分组关系图',
        button: '关系图',
        maxKeys: '每组 Key 上限',
        summary: '{groups} 个分组 · {keys} 个 Key · {accounts} 个账号',
        sourceGroup: '源分组',
        targetGroup: '目标分组',
        selectGroup: '选择分组',
        previewTransfer: '预览迁移',
        executeTransfer: '执行迁移',
        previewResult: '迁移预览',
        transferResult: '迁移结果',
        matchedCount: '命中 {count} 个 Key',
        updatedCount: '更新 {count} 个 Key',
        transferSaved: '分组关系已批量迁移',
        transferFailed: '批量迁移失败',
        loadFailed: '关系图加载失败'
      },
      subscription: {
        title: '订阅设置',
    ...
    accounts: {
      ...
      dataImportWarning: '导入将创建或更新账号与代理，分组需手工绑定。',
      dataImportFile: '数据文件',
      dataImportDuplicateAction: '重复账号',
      dataImportDuplicateOverwrite: '覆盖',
      dataImportDuplicateCopy: '创建副本',
      dataImportDuplicateIgnore: '忽略',
      dataImportBatchProxy: '统一代理',
      dataImportBatchProxyFile: '按文件',
      dataImportBatchProxyNone: '不使用代理',
      dataImportPlatformGroups: '平台分组',
      dataImportPlatformGroupNone: '不指定',
      dataImportOptionsLoadFailed: '导入选项加载失败',
      ...
      dataImportResultSummary: '代理创建 {proxy_created}，复用 {proxy_reused}，失败 {proxy_failed}；账号创建 {account_created}，更新 {account_updated}，忽略 {account_ignored}，失败 {account_failed}',
      dataImportErrors: '失败详情',
      dataImportSuccess: '导入完成：账号创建 {account_created}，更新 {account_updated}，忽略 {account_ignored}，失败 {account_failed}',
